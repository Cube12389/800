    ...
    <div class="container">
        ...
        <div class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="admin_logs.php" class="active">操作日志</a></li>
        ...
        <div class="main-content">
            ...
            <div class="card">
                <h2>操作日志列表</h2>
                <p>共 <?php echo $totalLogs; ?> 条操作记录</p>
                <table>
                    <thead>
                        <tr>
                            <th>ID</th>
                        ...
                        <?php if (count($logs) > 0): ?>
                            <?php foreach ($logs as $log): ?>
                                <tr>
                                    ...
                                    <td><?php echo $log['username'] ?? '未知管理员'; ?></td>
                ...
                <?php if ($totalPages > 1): ?>
                    <div class="pagination">
                        <?php if ($page > 1): ?>
                            <a href="admin_logs.php?page=<?php echo $page - 1; ?>">上一页</a>
                        <?php else: ?>
                        ...
                        <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                            ...
                            <?php else: ?>
                                <a href="admin_logs.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
                            <?php endif; ?>
                        <?php endfor; ?>
                        
                        <?php if ($page < $totalPages): ?>
                            <a href="admin_logs.php?page=<?php echo $page + 1; ?>">下一页</a>
                        <?php else: ?>
